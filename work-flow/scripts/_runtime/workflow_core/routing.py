...
ROUTES = {
    "plan": {"role": "pm", "model": "gpt-5.6-sol", "requested_efforts": ["ultra", "max", "xhigh", "high"], "cli_efforts": ["ultra", "max", "xhigh", "high"]},
    "plan-review": {"role": "plan-reviewer", "model": "gpt-5.6-sol", "requested_efforts": ["ultra", "max", "xhigh", "high"], "cli_efforts": ["ultra", "max", "xhigh", "high"]},
    ...
    "risk": {"role": "risk-reviewer", "model": "gpt-5.6-sol", "requested_efforts": ["ultra", "max", "xhigh", "high"], "cli_efforts": ["ultra", "max", "xhigh", "high"]},
